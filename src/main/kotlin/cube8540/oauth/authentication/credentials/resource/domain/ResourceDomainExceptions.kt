...
class ResourceNotFoundException(code: String, description: String): ServiceException(code, description) {
    ...
    companion object {
        @JvmStatic fun instance(description: String) = ResourceNotFoundException(ErrorCodes.NOT_FOUND, description)
    }
}
...
class ResourceRegisterException(code: String, description: String): ServiceException(code, description) {
    ...
    companion object {
        @JvmStatic fun existsIdentifier(description: String) = ResourceRegisterException(ErrorCodes.EXISTS_IDENTIFIER, description)
    }
}
...
class ResourceInvalidException(code: String, errors: Collection<ValidationError>): ServiceInvalidException(code, errors) {
    ...
    companion object {
        @JvmStatic fun instance(errors: List<ValidationError>) = ResourceInvalidException(ErrorCodes.INVALID_REQUEST, errors)
    }
}