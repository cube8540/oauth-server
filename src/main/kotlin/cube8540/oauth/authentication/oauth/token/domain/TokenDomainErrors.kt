...
class TokenAccessDeniedException(code: String, description: String): ServiceException(code, description) {
    companion object {
        @JvmStatic
        fun denied(description: String) = TokenAccessDeniedException(ErrorCodes.ACCESS_DENIED, description)
    }
}
...
class TokenNotFoundException(code: String, description: String): ServiceException(code, description) {
    companion object {
        @JvmStatic
        fun instance(description: String) = TokenNotFoundException(ErrorCodes.NOT_FOUND, description)
    }
}