...
insert into oauth2_client_scope(client_id, scope_id) select 'oauth-client', 'management.secured-resource' where not exists (select initialize_datetime from initialize);
