...
insert into authority_accessible_resources(authority, resource_id) select 'management.server', 'AUTHORITIES-API' where not exists (select initialize_datetime from initialize);
