...
public class ClientCredentialsFlowTokenFactory implements OAuth2TokenFactory {
    ...
    public ClientCredentialsFlowTokenFactory(OAuth2TokenIdGenerator tokenIdGenerator) {
