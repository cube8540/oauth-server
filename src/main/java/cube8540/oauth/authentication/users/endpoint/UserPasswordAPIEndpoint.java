...
public class UserPasswordAPIEndpoint {
    ...
    @PutMapping(value = "/api/accounts/{username}/attributes/password")
    ...
    public UserProfile changePassword(@ApiParam(name = "username", required = true, example = "username") @PathVariable("username") String username,
                                      @RequestBody ChangePasswordRequest changeRequest) {
        return service.changePassword(username, changeRequest);
    }
