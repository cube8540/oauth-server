...
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.ADD_AUTHORITIES;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.ADD_REQUEST_AUTHORITIES;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.AUTHORITIES;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.MODIFY_RESOURCE_URI;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.RAW_MODIFY_RESOURCE_URI;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.RAW_RESOURCE_ID;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.RAW_RESOURCE_URI;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.REMOVE_AUTHORITIES;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.REMOVE_REQUEST_AUTHORITIES;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.REQUEST_AUTHORITIES;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.RESOURCE_ID;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.RESOURCE_URI;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.makeDefaultSecuredResource;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.makeEmptyResourceRepository;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.makeErrorValidatorFactory;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.makeResourceRepository;
import static cube8540.oauth.authentication.resource.application.SecuredResourceApplicationTestHelper.makeValidatorFactory;
