...
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeClientDetails;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeClientDetailsService;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeEmptyClientDetailsService;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeExceptionClientDetailsService;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeMismatchPasswordEncoder;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makePasswordEncoder;
