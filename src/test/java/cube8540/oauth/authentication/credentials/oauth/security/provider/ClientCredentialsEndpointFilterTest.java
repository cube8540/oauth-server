...
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.BASIC_AUTH_CLIENT_ID;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.BASIC_AUTH_CLIENT_SECRET;
...
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.FILTER_PATH;
...
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeAuthentication;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeAuthenticationManager;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeBasicAuthenticationHttpServletRequest;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeFilterChain;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeGetHttpServletRequest;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeHttpServletResponse;
import static cube8540.oauth.authentication.credentials.oauth.security.provider.ClientCredentialsProviderTestHelper.makeParameterHttpServletRequest;
