...
class AbstractOAuth2TokenGranterTest {
    ...
    @Test
    @DisplayName("엑세스 토큰의 소유자가 요청한 클라이언트로 이미 인증을 받은 상태일 떄 새 엑세스 토큰을 부여")
    void accessTokenGrantsNewTokenWhenAlreadyAuthenticatedByRequestedClient() {
        ...
        OAuth2AuthorizedAccessToken existsAccessToken = makeAccessToken();
